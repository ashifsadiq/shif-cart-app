            ...
            {productData.map((product) => (
                ...
                >
                    <img
                        src={product.image}
                        alt={product.name}
                        className="md:6 h-56 w-[40%] md:w-full object-contain transition-transform duration-300 group-hover:scale-105 md:group-hover:scale-102 lg:h-[400px] bg-foreground dark:bg-foreground"
                    />
